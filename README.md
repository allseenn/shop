...
Данная инструкция посвящена второму заданию контрольной работы, объединенную автором данной инструкции в один проект двух Задач - программ:

1. Задача Ubuntu - программа в скрипе *linux.sh*
2. Задача Java - программа в папке *java*
