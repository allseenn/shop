...
Программный код каждой Задачи может быть запущенны по отдельности, либо совместно. Архитектура обеих программ построена таким образом, что используются общие папки и файлы, в тоже время, ничто не мешает использовать их по отдельности.
