...
Данная инструкция посвящена второму заданию контрольной работы, объединенную мной в один проект ([**shop**](#startsh-исполнение-двух-задач-одним-скриптом)) с решением двух Задач:
