...
Работа скриптов и программ проверена на следующих системах:
- Xbuntu 20.04
- Ubuntu 22.04
- Windows 11 в среде Github Bash
- Android в Termux с установленным openjdk-9

В случае, отсутствия какого либо функционала, например snapd, появляется сообщение, без ошибки.
...
Но, можно запустить java программу в составе стартового скрипта start.sh выбрав пункт 2.
