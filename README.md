...
Данная инструкция посвящена второму заданию контрольной работы, объединенную мной в один проект с решением двух Задач ([start.sh](#startsh-исполнение-двух-задач-одним-скриптом)):

1. [Задача по Ubuntu](#1задача-по-ubuntu) - bash-скрипт *linux.sh*
2. [Задача по Java](#2задача-по-java) - java-приложение
...
Работа *bash* скриптов и *java* програмы проверена на следующих системах:

- Xbuntu 20.04
- Ubuntu 22.04
- Windows 11 в среде Github Bash
- Android в Termux с установленным openjdk-9
