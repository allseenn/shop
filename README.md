...
Программный код каждой Задачи может быть запущен по отдельности, либо совместно. Архитектура обеих программ построена таким образом, что используются общие папки и файлы, в тоже время, ничто не мешает использовать их по отдельности.

## start.sh исполнение двух задач одним скриптом

Готовый код обеих Задач размещен на [гитхабе](https://github.com/allseenn/shop.git) и представляют одну директорию **shop**, в которой лежат:
