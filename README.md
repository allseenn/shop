...
Программный код каждой Задачи может быть запущен по отдельности, либо совместно, с помощью стартового скрипта **start.sh**. Структура папок и файлов из Задачи по Ubuntu совместима с Задачей по Java, в которой эти файлы используются как база данных для хранения информации по игрушкам.
