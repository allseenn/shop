...
Данная инструкция посвящена второму заданию контрольной работы, объединенную мной в один проект([start.sh](#startsh-исполнение-двух-задач-одним-скриптом)) с решением двух Задач:
